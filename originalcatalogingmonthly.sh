...
cat /software/WYLD/WYLDtemp/oclc2.txt | selcatalog -iC -oCe -e001 -f~COMMINFO,DUBLINCORE,EQUIP,ONORDER,ONTHEFLY,ROOM,SERIAL| grep -v "o\(c\|n\)" >/software/WYLD/WYLDtemp/oclc3.txt
