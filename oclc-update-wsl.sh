...
selitem -yWSL -t~AV-EQUIP,ARCHIVES,BACKPACK,BOOKCLUB,BOUNDPER,CAMCORDER,CASSPLAYER,CHSTEAMKIT,CHTOYS,COPIES,DIGT_PLAYR,DISCARD,EBOOK,EQUIPMENT,EREADER,FAXCARD,GAME,GUESTPASS,HOTSPOT,ILL,ILL-BOOK,JUVKIT,JUV-LOCREQ,JUVMAG,KEY,KIT,KITCHTOOLS,LAPTOP,LAPTOP_AD,LAUNCHPAD,LEASEDBOOK,LIB_THINGS,LOCAL-REQ,MISC,NEWSPAPER,NONCIRC,ONLINEDOC,ONTHEFLY,PERIODICAL,PRINTOUT,PROJECTOR,PUZZLE,REALIA,REFUND,RECD_PLAYR,REF-BOOK,SCREEN,SOFTWARE,SPECIAL,TABLET,TELESCOPE,UNKNOWN,YACRAFTKIT,YAKIT,YAMAG,2HRLOAN -l~ON-ORDER -oC | selcatalog -iC "-r>$yesterdate<$today" -oC > /software/WYLD/WYLDtemp/oclc1.txt
sort -u /software/WYLD/WYLDtemp/oclc1.txt > /software/WYLD/WYLDtemp/oclc2.txt
cat /software/WYLD/WYLDtemp/oclc2.txt | selcatalog -iC -oCe -e001 -fSERIAL | grep oc  >/software/WYLD/WYLDtemp/oclc3.txt
cat /software/WYLD/WYLDtemp/oclc2.txt | selcatalog -iC -oCe -e001 -fSERIAL| grep on  >>/software/WYLD/WYLDtemp/oclc3.txt
